...
- Wrap iframe in a responsive container so it scales on mobile
- Include a note directing users to contact for booking

### 5. Location
- Property address / area description: Panama City Beach, FL
- Nearby attractions (Pier Park, beach, restaurants)
...
All images are located in the `images/` folder at the project root:
...
| `Laundry.jpg` | Amenity |
| `IMG_0309.jpg` | General |
| `IMG_7346.jpg` | General |
| `IMG_7690.jpg` | General |
| `IMG_8529.JPG` | General |
| `IMG_8574.JPG` | General |
...
│   └── Contact.tsx
├── assets/
│   └── images/              # Symlink or copy of /images folder
└── App.tsx
```
